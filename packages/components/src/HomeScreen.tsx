...
<CustomTextItem content={'Elasticsearch2'}  onPress={() => navigation.navigate("Elasticsearch2")} />
...
<CustomTextItem content={'Ordercreation2'}  onPress={() => navigation.navigate("Ordercreation2")} />
