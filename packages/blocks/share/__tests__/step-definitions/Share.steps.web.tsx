...
defineFeature(feature, (test) => {
    ...
    test('User navigates to Share', ({ given, when, then }) => {
        ...
        then('I can select the button with with out errors', () => {
            let buttonComponent = shareBlock.findWhere((node) => node.prop('data-test-id') === 'btnShare');
            buttonComponent.simulate('press')

            buttonComponent = shareBlock.findWhere((node) => node.prop("data-test-id") === "btnHideModal");
            buttonComponent.simulate("click")

            buttonComponent = shareBlock.findWhere((node) => node.prop("data-test-id") === "btnShowModal");
            buttonComponent.simulate("click")
        });
