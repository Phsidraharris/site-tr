...
defineFeature(feature, (test) => {
    ...
    test('User navigates to customisableuserprofiles2', ({ given, when, then }) => {
        ...
        given('I am a User loading customisableuserprofiles2', () => {
            exampleBlockA = shallow(<Customisableuserprofiles2 {...screenProps}/>);
        });

        when('I navigate to the customisableuserprofiles2', () => {
             instance = exampleBlockA.instance() as Customisableuserprofiles2
        });

        then('customisableuserprofiles2 will load with out errors', () => {
