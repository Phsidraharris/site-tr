...
defineFeature(feature, (test) => {
  ...
  test("User navigates to Chat", ({ given, when, then }) => {
    ...
    then("I will navigate to that chat room", () => {
      // const navigationRaiseMessage: Message = {
      //   id: "NavigationPayLoadMessage",
      //   initializeFromObject: expect.any(Function),
      //   messageId: expect.any(String),
      //   properties: { SessionResponseData: { chatId: "7" } },
      //   addData: jest.fn(),
      //   getData: jest.fn(),
      //   copyAllPropertiesOf: jest.fn(),
      // };
      // const runEngineResult: Message = {
      //   id: "NavigationMessage",
      //   initializeFromObject: expect.any(Function),
      //   messageId: expect.any(String),
      //   properties: {
      ...
      //     NavigationTargetMessage: "ChatView",
      //   },
      //   addData: jest.fn(),
      //   getData: jest.fn(),
      //   copyAllPropertiesOf: jest.fn(),
