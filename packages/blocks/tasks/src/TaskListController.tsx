...
export default class TaskListController extends BlockComponent<Props, S, SS> {
  ...
  getTaskLists = () => {
    ...
    const catalogueId = 4; //Need to change to selected catalogue id
    const header = {
    ...
    requestMessage.addData(
      ...
      `${configJSON.tasksListApiEndPoint}?catalogue_id=${catalogueId}`
    );
  ...
  handleClickMenu = (event: React.MouseEvent<HTMLButtonElement>) => {
